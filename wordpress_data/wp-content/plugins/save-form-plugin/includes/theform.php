...
<div class="form-wrap">
    ...
    <div class="col-lg-10">
        <form action="" method="POST" class="ajax" >
            ...
            <input type="text" class="form-control" name="u_fname" id="u_fname" placeholder="&#42;First name" aria-label="Enter First Name" required>
            </div>

            <div class="form-group col-md-6 pl-md-4">
            <input type="text" class="form-control" name="u_lname" id="u_lname" placeholder="&#42;Last name" aria-label="Enter Last Name"  required>
            </div>

            <div class="form-group col-md-6 pr-md-4">
            <input type="email" class="form-control" name="u_email" id="u_email" placeholder="&#42;Email" aria-label="Enter Email ID"  required>
            </div>

            <div class="form-group col-md-6 pl-md-4">
            <input type="tel" class="form-control" name="u_phone" id="u_phone" placeholder="Phone Number" aria-label="Enter Phone Number"  pattern="[0-9]{6}[0-9]{2}[0-9]{3}">
            </div>
            ...
            <div class="col-12 text-center d-md-none position-absolute form-image">
                <img  class="" src="<?php echo WP_PLUGIN_URL.'/save-form-plugin/includes/css/Image.png'; ?>" alt="Decorative image for the form" />
            </div>
